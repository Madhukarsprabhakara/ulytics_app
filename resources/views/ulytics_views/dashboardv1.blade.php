	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="/" class="navbar-brand"><span class="navbar-logo"></span> <b>ulytics</b></a>
...
<script>
				...
				<div class="col-lg-4">
					...
					<div class="panel panel-inverse" data-sortable-id="index-8">
						...
						<div class="panel-body p-0">
							...
							<!-- <button  @click="setTimer" class="btn btn-primary">Add task</button> -->
						</div>
						<div class="panel-footer text-right">
							<input type="text" placeholder="Task name" class="form-control m-b-5" v-model="task_name"  />
							
							<a href="javascript:;" class="btn btn-primary btn-sm m-l-5">Add a To-do item</a>
						</div>
					</div>
					<!-- end panel -->
  ...
  // }
		methods: {
			...
			markToDoListItemComplete:function()
			{
